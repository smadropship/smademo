                                    ...
                                    <div class="tab-content padding-lg">
                                        <div role="tabpanel" class="tab-pane fade in active" id="user">
                                            ...
                                            ?>
                                                ...
                                                <hr>
                                                <h5><strong><?= lang('ชำระทาง'); ?></strong></h5>
                                                <div class="checkbox bg">
                                                ...
                                                <h5><strong><?= lang('เลือกข่นส่งสินค้า'); ?></strong></h5>
                                                <div class="checkbox bg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <form>
                                                <br>
                                                <div class="mb-3">
                                                    <label for="text" class="form-label">ที่อยู่</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="text" class="form-label">ตำบล</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="text" class="form-label">อำเภอ</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="text" class="form-label">จังหวัด</label>
                                                    <input type="text" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="text" class="form-label">รหัสไปรษณี</label>
                                                    <input type="text" class="form-control">
                                                </div>
